...
class Giohang extends CI_Controller {
    ...
    public function index(){
        $this->data['title']='BOOKSHOP - Giỏ hàng của bạn';
    ...
    public function info_order(){
        ...
        if($this->form_validation->run() == TRUE){
            ...
            $this->data['title']='BOOKSHOP - Thông tin đơn hàng';
    ...
    public function thankyou(){
        if($this->session->userdata('info-customer')||$this->session->userdata('sessionKhachHang')){
            ...
            $config['smtp_user']    = 'sale.book.shop.2019@gmail.com';
            ...
            $this->email->from('sale.smart.store.2019@gmail.com', 'BOOKSHOP');
            $list = array($val['email']);
            $this->email->to($list);
            $this->email->subject('Hệ thống BOOKSHOP');
        ...
        $this->data['title']='BOOKSHOP.vn - Kết quả đơn hàng';
