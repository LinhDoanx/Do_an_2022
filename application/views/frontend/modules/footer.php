    ...
    <div class="container">
        <div class="col-xs-12 col-sm-12 col-md-6">
            <div class="col-xs-12 col-sm-6">
                <a href="trang-chu">
                    <img src="public/images/logo_book.png" style="width: 50%;" class="img-fix f-logo" alt="smart-construction">
                </a>
                <div class="about-store">
                BOOKSHOP Chất lượng - giá cả hợp lý
             </div>
         </div>
         <div class="col-xs-12 col-sm-6">
            <div class="f-contact">
                ...
                <ul class="list-unstyled">
                    ...
                    <li class="clearfix">
                        ...
                        <span><a href="mailto:bookshop@gmail.com">bookshop@gmail.com</a></span>
                    </li>
                </ul>
            </div>
        </div>
