<section class="logo-search">
  <div class="container">
    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 logo">
      <a href="<?php echo base_url() ?>"><img width="50%" src="<?php echo base_url() ?>public/images/logo_book.png" alt="Logo Shop"></a>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 search">
      <div class="contact-row">
        <div class="phone inline">
          <i class="icon fa fa-phone"></i> 0123 456 789
        </div>
        <div class="contact inline">
          <i class="icon fa fa-envelope"></i> bookshop@gmail.com
        </div>
      </div>
