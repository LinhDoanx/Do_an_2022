					...
					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
						<div class="product-view-content">
								...
								<div id="km-detail">
									...
									<div class="fk-main">
										<div class="fk-sales">
											...
											<ul>
												<li>Nhập mã FREESHIP để được miễn phí vận chuyển với đơn từ 300.000đ</li>
											</ul>
											<ul>
												<li>Tặng tập truyện Shin - Cậu bé bút chì (Áp dụng đến 26/05) <a href="#" target="_blank">Xem chi tiết</a>
												</li>
											</ul>
											<ul>
												<li>Giảm thêm 900,000đ khi mua combo doremon <a href="#" target="_blank">Xem chi tiết</a>
												</li>
											</ul>
										</div>
									</div>
							...
							<div style="margin-top: 20px;">
								<b>Tình trạng</b>
								<br>
								<span>Nguyên tem. Đầy đủ gói hàng từ nhà sản xuất.</span>
							</div>
							<div style="margin-top: 20px;">
								<b>Bảo hành</b>
								<br>
								<span>Đổi trả sản phẩm nếu phát hiện lỗi của nhà sản xuất</span><a href="#" style="color:red"> (Chi tiết)</a>
							</div>
						</div>
					</div>
