    ...
    <div class="slider">
        <div class="container">
           <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 list-menu pull-left" style="height: 321px;">
             <img style="width: 100%; height: 160px;" src="public/images/banner_book2_mini.png">
             <img style="width: 100%; height: 160px;" src="public/images/banner_book1_mini.png">
         </div>
    ...
    <div class="container">
        <div class="row-p">
            <div class="text-center">
                <h2 class="sectin-title title title-blue">Tin tức nổi bật</h2>
            </div>
        </div>
        <div class="blog-content">
            ...
            foreach ($listBaiViet as $rowPost) :?>
                <div class="col-xs-12 col-12 col-sm-6 col-md-4 col-lg-4" style="margin: 18px; width:30%;align-items:center">
                    <div class="latest">
